...
*   **一、规划问题的表示 (Planning Problem Representation)**
    *   **STRIPS (Stanford Research Institute Problem Solver):**
        ...
        *   ![1765014048203](image/杨欢重点/1765014048203.png)
    *   **ADL (Action Description Language):**
        *   比 STRIPS 更丰富，允许负文字、开放世界假设、量词（forall/exists）、条件效果等。
        *   ![1765014062586](image/杨欢重点/1765014062586.png)
    *   **PDDL (Planning Domain Definition Language):**
        *   现代标准语言，核心基于 STRIPS 和 ADL。
        *   文件结构分为：**Domain File**（定义谓词和动作/操作符）![1765014078957](image/杨欢重点/1765014078957.png)和 **Problem File**（定义对象、初始状态和具体目标）![1765014089169](image/杨欢重点/1765014089169.png)。
